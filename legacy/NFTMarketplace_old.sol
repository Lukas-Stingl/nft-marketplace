...
contract NFTMarketplace {
    ...
    //<-------------------------Fixed Price Offer Data Types and Events---------------------------------------->
    ...
    //     return (nftCollection.ownerOf(_tokenId) == _claimant);
    // }
    ...
    //     nftCollection.transferFrom(_owner, this, _tokenId);
    // }
    ...
    //     // it will throw if transfer fails
    //     nftCollection.transfer(_receiver, _tokenId);
    // }
    ...
    //         // uncomment for implementing cuts
...
// contract ClockAuctionMechanism is NFTMarketplace {
...
//         nftCollection = candidateContract;
//     }
